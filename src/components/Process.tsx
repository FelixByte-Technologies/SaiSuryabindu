  ...
  const installationSteps = [
    {
      ...
      description:
        "With consumer's consent and timing, on the day of agreement with advance amount, we will apply in online portal both for installation & subsidy.",
      duration: "1-2 days",
    },
    {
      step: 2,
      ...
      description:
        "Only after approval from DISCOM, we will install the solar panel with MCB, SPD, earthing, Lightning Arrester and mark the space for installation.",
      duration: "5-10 days",
    },
    {
      step: 3,
      ...
      description:
        "Install solar panels with all necessary equipment and take photographs of the installation site with consumer to upload on portal as proof of completion.",
      duration: "1 day",
    },
    {
      step: 4,
      ...
      description:
        "Within 10 days after certification and inspection from DISCOM(TPCODL), the total 'ON GRID system' will be fit at your place.",
      duration: "10 days",
    },
    {
      step: 5,
      ...
      description:
        "After DISCOM(TPCODL) certification, the subsidy will be released in consumer accounts.",
      duration: "5-15 days",
    },
    {
      step: 6,
      ...
      description:
        "After installation, from next month, electric bill will be ZERO and that will continue for upcoming 25 years (approx.).",
      duration: "Ongoing",
    },
  ];
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Complete solar installation in 15-30 working days
            </p>
          </div>
                ...
                >
                  ...
                  <div className="flex-1 bg-white rounded-lg shadow-lg p-6 w-full">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-3">
                      <h4 className="text-xl font-bold text-gray-800 text-center md:text-left mb-2 md:mb-0">
                        {step.title}
                      </h4>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <div className="text-green-100">
                  Bank Loan(if any) and Discom approval (if more than 10 KW)
                </div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-yellow-300 mb-2">
          ...
          <div className="mt-16 bg-yellow-50 border-l-4 border-yellow-400 p-6 rounded-lg">
            ...
            <ul className="space-y-2 text-yellow-700">
              <li>
                • Time period may vary due to unforeseen problems or technical
                issues
              </li>
              <li>
                • Professional site visit required to determine optimal
                installation location
              </li>
              <li>
                • All safety measures and electrical standards will be followed
              </li>
              <li>• Complete documentation and portal management included</li>
              <li>
                • 30 minutes free time required for OTP sharing during portal
                registration
              </li>
            </ul>
          </div>
